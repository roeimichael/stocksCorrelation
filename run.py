...
Replaces all .bat and .sh scripts with a single Python entry point.
...
def run_live_signals(args):
    ...
    from scripts.live_daily import main as live_daily_main
...
def run_paper_trade(args):
    ...
    from scripts.paper_trade_daily import main as paper_trade_main
...
def run_multi_strategy(args):
    ...
    from scripts.run_multi_strategy_paper_trading import main as multi_strategy_main
...
def run_daily(args):
    ...
    from daily_runner import main as daily_runner_main
